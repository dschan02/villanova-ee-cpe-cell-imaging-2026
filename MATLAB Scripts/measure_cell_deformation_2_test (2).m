...
if strcmp(doRemove,'Yes')
    ...
    cmd = sprintf('ffmpeg -y -fflags +genpts -i "%s" -vf "mpdecimate,setpts=N/FRAME_RATE/TB" -vsync vfr -c:v libx264 -crf 18 -preset veryfast -c:a copy "%s"', vidPath, stampedPath);
